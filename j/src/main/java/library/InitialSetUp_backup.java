...
public class InitialSetUp_backup {
	...
	public InitialSetUp_backup() throws Exception {
...
//		cmd = System.getProperty("parameter"); // This is not used in the project
...
//		System.out.println("brwsStackURL ::: " +brwsStackURL);
		...
		/*if (executionTimes == 0) {
			System.out.println("Waiting for build to deploy");
			...
			if (browser.equalsIgnoreCase("CHROME")) {
				...
				*/
				...
				/*SafariOptions options2 = new SafariOptions();
				 ...
				 capabilities.setCapability(SafariOptions.CAPABILITY, options2);*/
